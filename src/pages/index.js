...
const IndexPage = () => {
  ...
  {/* script */}
      <div class="ec-cart-widget"></div>
        <div class="hi">
            <script data-cfasync="false" type="text/javascript" src="https://app.ecwid.com/script.js?86415007&data_platform=code&data_date=2023-06-04" charset="utf-8" style="display: block"></script>
